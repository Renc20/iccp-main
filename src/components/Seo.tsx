...
const defaultMeta = {
  title: 'International Coalition of Christian Pastors',
  siteName: 'International Coalition of Christian Pastors',
  description:
   ...
   */
  image:
    'https://res.cloudinary.com/dakfmjumy/image/upload/v1676175817/iccp/large-og_b3za1e.jpg',
};
    ...
    <Head>
      ...
      {meta.date && (
        <>
          ...
          <meta name='author' property='article:author' content='ICCP' />
        </>
      )}
